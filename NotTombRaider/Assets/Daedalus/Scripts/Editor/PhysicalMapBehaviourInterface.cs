    ...
    public override void OnInspectorGUI()
    {
        ...
        if (v.createStartAndEnd)
        {
            ...
            if (t.createEntranceAndExit)
            {
                ...
                t.createPlayerThief = EditorGUILayout.Toggle("Add Player Thief", t.createPlayerThief);
                if (t.createPlayerThief) t.thiefPrefab = EditorGUILayout.ObjectField("Thief Prefab", t.thiefPrefab, typeof(GameObject), true) as GameObject;
                t.createPlayerFighter = EditorGUILayout.Toggle("Add Player Fighter", t.createPlayerFighter);
                if (t.createPlayerFighter) t.fighterPrefab = EditorGUILayout.ObjectField("Fighter Prefab", t.fighterPrefab, typeof(GameObject), true) as GameObject;
